...
LD_LIBRARY_PATH=$FUSE_HOME/lib:${JAVA_HOME}/jre/lib/i386/server:/home/ronen/CodeProjects/fuse4j/native/
...
mvn assembly:assembly -Djava.library.path=$LD_LIBRARY_PATH
